...
export 'legal_version.dart';

/// Full legal copy for in-app and admin surfaces. Keep in sync with
/// `admin-web/src/legal/legalContent.ts` when text changes.

/// Privacy Policy — ExpatHomes (Firebase-backed housing platform).
const String kPrivacyPolicyText = '''
EXPAT HOMES — PRIVACY POLICY
Effective date: March 27, 2026 • Document version: $kLegalDocumentsVersion
...
/// Payments-related terms (external MoMo / user-arranged transfers).
const String kPaymentsTermsText = '''
...
/// Nondiscrimination and fair housing alignment.
const String kNondiscriminationPolicyText = '''
